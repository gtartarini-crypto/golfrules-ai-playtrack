...
export const PlayerHome: React.FC<PlayerHomeProps> = (props) => {
  ...
  return (
    <div className="h-full flex flex-col bg-slate-950 font-sans overflow-hidden">
          ...
          <div className="flex-1 bg-slate-950 p-2.5 rounded-2xl border border-white/5 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3 border-l border-white/10 pl-3">
              <div className="text-right">
                ...
                <p className="text-[9px] font-bold text-emerald-400 uppercase leading-none truncate max-w-[60px]">
              ...
              {rescueSubMode === 'main' ? (
                ...
                <>
                  <div className="flex items-center justify-between mb-2">
                    <button onClick={() => setRescueSubMode('main')} className="p-2 text-slate-500 hover:text-white"><ArrowLeft size={20}/></button>
      ...
      <RuleModal isOpen={showCartRulesModal} onClose={() => setShowLocalRulesModal(false)} title="Regolamento Cart" content={localRulesData?.golfCartRules} icon={GolfCartIcon} color="blue" />
